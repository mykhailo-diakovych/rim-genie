  ...
  return (
    <div className="flex flex-1 flex-col gap-5 p-3 sm:p-5">
      ...
      <div className="overflow-hidden rounded-xl border border-card-line bg-white shadow-card">
        <div className="grid grid-cols-[1fr_auto] border-b border-card-line px-3 py-2 sm:grid-cols-[48px_1fr_120px_124px]">
          <span className="hidden font-rubik text-xs leading-3.5 text-label sm:block">#</span>
          <span className="font-rubik text-xs leading-3.5 text-label">Description</span>
          <span className="hidden font-rubik text-xs leading-3.5 text-label sm:block">Status</span>
          <span />
        </div>
