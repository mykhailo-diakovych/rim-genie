          ...
          Effect.gen(function* () {
            ...
            if (pref === "email") {
              ...
              yield* SmsService.send({
                to: cust.phone,
                text: `Hi ${cust.name}, your Rim Genie receipt for invoice ${inv.invoiceNumber}. Total: JMD ${(inv.total / 100).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}, Paid: JMD ${(totalPaid / 100).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}, Balance: JMD ${(balance / 100).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}.`,
              });
            }
        ...
        return runEffect(
          Effect.gen(function* () {
            ...
            if (pref === "email") {
              ...
              yield* SmsService.send({
                to: cust.phone,
                text: `Hi ${cust.name}, reminder: invoice ${inv.invoiceNumber} has an outstanding balance of JMD ${(balance / 100).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}. Please settle before pickup. - Rim Genie`,
              });
            }
